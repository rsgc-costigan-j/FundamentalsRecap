...
//Drawing first circles
for y in stride(from: 370, to: 30, by: -150){
    for x in stride(from: 30, to: 401, by: 55){
...
//Drawing inverted colors circles
for h in stride(from: 320, to: 0, by: -150){
    for w in stride(from: 57.5, to: 401, by: 55){
        canvas.fillColor = Color(hue: 53, saturation: 93, brightness: 98, alpha: 100)
...
//drawing white lines
canvas.drawRectangle(centreX: 200, centreY: Int(345), width: 400, height: 50)
/*:
 ## Template code
